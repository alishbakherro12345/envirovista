...
import 'package:envirovista/utils/dailyschoolarfootprint/foot_print_2.dart';
...
class FootPrint3 extends StatefulWidget {
  ...
  @override
  State<FootPrint3> createState() => _FootPrint3State();
}

class _FootPrint3State extends State<FootPrint3> {
                ...
                GestureDetector(
                  ...
                  onTap: () {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                        builder: (BuildContext context) => FootPrint2()));
                  },
                ),
                SizedBox(width: 15),
                Text(
                            ...
                            child: RoundButton(
                              ...
                              onTap: () {
                                ...
                                Navigator.of(context).pushReplacement(
                                    MaterialPageRoute(
                                        builder: (BuildContext context) => FootPrint4()));
  ...
  void _saveData() async {
    ...
    final footPrintName = 'Consumption';
