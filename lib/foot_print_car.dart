...
class FootPrintCar extends StatefulWidget {
  const FootPrintCar({super.key});

  @override
  State<FootPrintCar> createState() => _FootPrintCarState();
}

class _FootPrintCarState extends State<FootPrintCar> {
  ...
  Future<bool> _saveData() async {
    ...
    try {
      ...
      questions.add(QuestionModel('2', 'Destination (Department)', '0',_question3.text));
      questions.add(QuestionModel('3', 'How often do you use your car for commuting university?', '0',_selectedValue4));
      questions.add(QuestionModel('4', 'What type of car do you primarily use for ?', '0',_selectedValue5));
      questions.add(QuestionModel('5', 'Approximately how many kilometers do you travel one way from home to university?', '0',_question6.text));
      questions.add(QuestionModel('6', 'Approximately how many time do you travel one way from home to university?', '0',_question7.text));
      questions.add(QuestionModel('7', 'Manufacturer of your car?', '0',_question8.text));
      questions.add(QuestionModel('8', 'What is the engine capacity(cc) of your car?', '0',_selectedValue9));
